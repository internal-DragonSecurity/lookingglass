...
import (
	...
	"github.com/dragonsecurity/lookingglass/internal/database"
	"github.com/dragonsecurity/lookingglass/internal/env"
	"github.com/dragonsecurity/lookingglass/internal/smtp"
...
func run(logger *slog.Logger) error {
	...
	cfg.baseURL = env.GetString("BASE_URL", "http://localhost:4041")
	cfg.httpPort = env.GetInt("HTTP_PORT", 4041)
	...
	cfg.cookie.secretKey = env.GetString("COOKIE_SECRET_KEY", "rtald64avj5z6dvysfrpe3djzkcdmrjm")
	cfg.db.dsn = env.GetString("DB_DSN", "db.sqlite")
	cfg.db.automigrate = env.GetBool("DB_AUTOMIGRATE", true)
	cfg.notifications.email = env.GetString("NOTIFICATIONS_EMAIL", "")
	cfg.session.secretKey = env.GetString("SESSION_SECRET_KEY", "hpwchbb7fqezn2hcllqo5zn5aw3a6rc2")
